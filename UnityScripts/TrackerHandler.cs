...
{
    //public ArmAngleCalculator kinectAngleCalculator;
    ...
    public Vector3[] absoluteJointPositions = new Vector3[(int)JointId.Count];
    ...
    {
        // Store the tracker data in the ArmAngleCalculator for use
        //if (kinectAngleCalculator != null)
        //{
        //kinectAngleCalculator.SetTrackerFrameData(trackerFrameData); // Pass the data to ArmAngleCalculator
        //}
    ...
    public void renderSkeleton(Body skeleton, int skeletonNumber)
    {
        for (int jointNum = 0; jointNum < (int)JointId.Count; jointNum++)
        {
            ...
            absoluteJointPositions[jointNum] = positionInTrackerRootSpace;
